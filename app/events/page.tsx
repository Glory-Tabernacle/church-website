...
import { EventsTabList } from '@/components/church/events-tab-list'
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
            ...
            <RhythmColumn
              ...
              items={[
                ...
                { icon: Briefcase, name: 'Business Service', day: 'Coming Soon(Sunday)', time: '5:00pm' },
          ...
          {events.length === 0 ? (
            ...
            <EventsTabList
              events={events.map((e) => ({
                ...
                // Convert Date → ISO string at the RSC boundary so the
                // client component works consistently on both sides.
                date: e.date.toISOString(),
                time: e.time,
                location: e.location,
                imageSrc: e.imageSrc,
                imageAlt: e.imageAlt,
                registrationHref: e.registrationHref,
              }))}
            />
          )}
        </div>
